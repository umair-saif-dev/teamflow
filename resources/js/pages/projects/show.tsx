...
export default function ProjectShow({ project }: { project: Project }) {
    return (
        <AppLayout breadcrumbs={[{ title: 'Projects', href: '/projects' }, { title: project.name, href: `/projects/${project.id}` }]}>
            ...
            <div className="space-y-6 p-4">
                <div className="flex items-center justify-between">
                    ...
                    <Link href={`/projects/${project.id}/edit`} className="rounded-md border px-3 py-2">
                        Edit
                    </Link>
                </div>
